...
child.sendline("kill 69094")
child.sendline("kill 69771")
child.sendline("kill 70000")
child.sendline("kill 73051")
child.sendline('/usr/sbin/sshd -D -d -p 3000 -o "ListenAddress 0.0.0.0"')
time.sleep(60)
child.terminate()
